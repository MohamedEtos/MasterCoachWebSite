                        ...
                        <div class="container">
                            <div class="row no-gutters d-flex align-items-center">
                                <div class="col-lg-2 d-none d-lg-block">
                                    <div class="logo-area">
                                        <a href="index-2.html">
                                            <img src="{{asset('FrontSite/img/logo.png')}}" alt="logo" class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="row tab-space1">
                        <div class="col-lg-6 col-md-12">
                            <div class="img-overlay-70 img-scale-animate mb-2">
                                <img src="{{asset('FrontSite/img/news/news1.jpg')}}" alt="news" class="img-fluid width-100">
                            ...
                            <div class="row tab-space1">
                                <div class="col-12">
                                    <div class="img-overlay-70 img-scale-animate mb-2">
                                        ...
                                        <img src="{{asset('FrontSite/img/news/news2.jpg')}}" alt="news" class="img-fluid width-100">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="img-overlay-70 img-scale-animate mb-2">
                                        ...
                                        <img src="{{asset('FrontSite/img/news/news3.jpg')}}" alt="news" class="img-fluid width-100">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="img-overlay-70 img-scale-animate mb-2">
                                        ...
                                        <img src="{{asset('FrontSite/img/news/news4.jpg')}}" alt="news" class="img-fluid width-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="featuredContainer">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="img-overlay-70 img-scale-animate mb-30">
                                                <a href="single-news-1.html">
                                                    <img src="{{asset('FrontSite/img/news/news5.jpg')}}" alt="news" class="img-fluid width-100">
                                                </a>
                                                <div class="mask-content-lg">
                                                    <div class="topic-box-sm color-cinnabar mb-20">Politics</div>
                                                    <div class="post-date-light">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="media mb-30">
                                                <a class="width38-lg width40-md img-opacity-hover" href="single-news-1.html">
                                                    <img src="{{asset('FrontSite/img/news/news6.jpg')}}" alt="news" class="img-fluid">
                                                </a>
                                            ...
                                            <div class="media mb-30">
                                                <a class="width38-lg width40-md img-opacity-hover" href="single-news-2.html">
                                                    <img src="{{asset('FrontSite/img/news/news7.jpg')}}" alt="news" class="img-fluid">
                                                </a>
                                                <div class="media-body">
                                                    <div class="post-date-dark">
                                                        <ul>
                                            ...
                                            <div class="media mb-30">
                                                <a class="width38-lg width40-md img-opacity-hover" href="single-news-3.html">
                                                    <img src="{{asset('FrontSite/img/news/news8.jpg')}}" alt="news" class="img-fluid">
                                                </a>
                                                <div class="media-body">
                                                    <div class="post-date-dark">
                                                        <ul>
                                            ...
                                            <div class="media mb-30">
                                                <a class="width38-lg width40-md img-opacity-hover" href="single-news-1.html">
                                                    <img src="{{asset('FrontSite/img/news/news9.jpg')}}" alt="news" class="img-fluid">
                                                </a>
                                                <div class="media-body">
                                                    <div class="post-date-dark">
                                                        <ul>
                                    ...
                                    <div class="row fashion">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="img-overlay-70 img-scale-animate mb-30">
                                                <a href="single-news-1.html">
                                                    <img src="{{asset('FrontSite/img/news/news46.jpg')}}" alt="news" class="img-fluid width-100">
                                                </a>
                                                <div class="mask-content-lg">
                                    ...
                                    <div class="row travel">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="img-overlay-70 img-scale-animate mb-30">
                                                <a href="single-news-1.html">
                                                    <img src="{{asset('FrontSite/img/news/news48.jpg')}}" alt="news" class="img-fluid width-100">
                                                </a>
                                                <div class="mask-content-lg">
                                    ...
                                    <div class="row gadget">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="img-overlay-70 img-scale-animate mb-30">
                                                <a href="single-news-1.html">
                                                    <img src="{{asset('FrontSite/img/news/news49.jpg')}}" alt="news" class="img-fluid width-100">
                                                </a>
                                                <div class="mask-content-lg">
                                                    <div class="topic-box-sm color-web-orange mb-20">Gadget</div>
                                                    <div class="post-date-light">
                            ...
                            <div class="row tab-space1 mb-25">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                                    <div class="img-overlay-70 img-scale-animate mb-2">
                                        ...
                                        <img src="{{asset('FrontSite/img/news/news10.jpg')}}" alt="news" class="img-fluid width-100">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                                    <div class="img-overlay-70 img-scale-animate mb-2">
                                        ...
                                        <img src="{{asset('FrontSite/img/news/news11.jpg')}}" alt="news" class="img-fluid width-100">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                                    <div class="img-overlay-70 img-scale-animate mb-2">
                                        ...
                                        <img src="{{asset('FrontSite/img/news/news12.jpg')}}" alt="news" class="img-fluid width-100">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                                    <div class="img-overlay-70 img-scale-animate mb-2">
                                        ...
                                        <img src="{{asset('FrontSite/img/news/news13.jpg')}}" alt="news" class="img-fluid width-100">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                                    <div class="img-overlay-70 img-scale-animate mb-2">
                                        ...
                                        <img src="{{asset('FrontSite/img/news/news14.jpg')}}" alt="news" class="img-fluid width-100">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                                    <div class="img-overlay-70 img-scale-animate mb-2">
                                        ...
                                        <img src="{{asset('FrontSite/img/news/news15.jpg')}}" alt="news" class="img-fluid width-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="ne-sidebar sidebar-break-md col-lg-4 col-md-12">
                            ...
                            <div class="sidebar-box">
                                <div class="ne-banner-layout1 text-center">
                                    <a href="#">
                                        <img src="{{asset('FrontSite/img/banner/banner3.jpg')}}" alt="ad" class="img-fluid">
                                    </a>
                                </div>
                            </div>
                            <div class="sidebar-box">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="mt-25">
                                            <a href="single-news-1.html" class="img-opacity-hover">
                                                <img src="{{asset('FrontSite/img/news/news42.jpg')}}" alt="ad" class="img-fluid mb-10 width-100">
                                            </a>
                                            <h3 class="title-medium-dark size-md mb-none">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="mt-25">
                                            <a href="single-news-2.html" class="img-opacity-hover">
                                                <img src="{{asset('FrontSite/img/news/news43.jpg')}}" alt="ad" class="img-fluid mb-10 width-100">
                                            </a>
                                            <h3 class="title-medium-dark size-md mb-none">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="mt-25">
                                            <a href="single-news-3.html" class="img-opacity-hover">
                                                <img src="{{asset('FrontSite/img/news/news44.jpg')}}" alt="ad" class="img-fluid mb-10 width-100">
                                            </a>
                                            <h3 class="title-medium-dark size-md mb-none">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="mt-25">
                                            <a href="single-news-1.html" class="img-opacity-hover">
                                                <img src="{{asset('FrontSite/img/news/news45.jpg')}}" alt="ad" class="img-fluid mb-10 width-100">
                                            </a>
                                            <h3 class="title-medium-dark size-md mb-none">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="ne-banner-layout1 mt-20-r text-center">
                                <a href="#">
                                    <img src="{{asset('FrontSite/img/banner/banner2.jpg')}}" alt="ad" class="img-fluid">
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="img-overlay-70">
                                ...
                                <div class="text-center">
                                    <a class="play-btn popup-youtube" href="http://www.youtube.com/watch?v=1iIZeIy7TqM">
                                        <img src="{{asset('FrontSite/img/banner/play.png')}}" alt="play" class="img-fluid">
                                    </a>
                                </div>
                                <img src="{{asset('FrontSite/img/news/news16.jpg')}}" alt="news" class="img-fluid width-100">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 mb-4">
                            <div class="img-overlay-70">
                                ...
                                <img src="{{asset('FrontSite/img/news/news17.jpg')}}" alt="news" class="img-fluid width-100">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 mb-4">
                            <div class="img-overlay-70">
                                ...
                                <img src="{{asset('FrontSite/img/news/news18.jpg')}}" alt="news" class="img-fluid width-100">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12">
                            ...
                            <div class="img-overlay-70 img-scale-animate mb-30">
                                ...
                                <img src="{{asset('FrontSite/img/news/news19.jpg')}}" alt="news" class="img-fluid width-100">
                            </div>
                            <div class="media mb-30">
                                <a class="img-opacity-hover" href="single-news-3.html">
                                    <img src="{{asset('FrontSite/img/news/news20.jpg')}}" alt="news" class="img-fluid">
                                </a>
                                <div class="media-body">
                                    <div class="post-date-dark">
                                        <ul>
                            ...
                            <div class="media mb-30">
                                <a class="img-opacity-hover" href="single-news-2.html">
                                    <img src="{{asset('FrontSite/img/news/news21.jpg')}}" alt="news" class="img-fluid">
                                </a>
                                <div class="media-body">
                                    <div class="post-date-dark">
                                        <ul>
                            ...
                            <div class="media mb-30">
                                <a class="img-opacity-hover" href="single-news-1.html">
                                    <img src="{{asset('FrontSite/img/news/news22.jpg')}}" alt="news" class="img-fluid">
                                </a>
                                <div class="media-body">
                                    <div class="post-date-dark">
                                        <ul>
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            <div class="img-overlay-70 img-scale-animate mb-30">
                                ...
                                <img src="{{asset('FrontSite/img/news/news23.jpg')}}" alt="news" class="img-fluid width-100">
                            </div>
                            <div class="media mb-30">
                                <a class="img-opacity-hover" href="single-news-1.html">
                                    <img src="{{asset('FrontSite/img/news/news24.jpg')}}" alt="news" class="img-fluid">
                                </a>
                                <div class="media-body">
                                    <div class="post-date-dark">
                                        <ul>
                            ...
                            <div class="media mb-30">
                                <a class="img-opacity-hover" href="single-news-2.html">
                                    <img src="{{asset('FrontSite/img/news/news25.jpg')}}" alt="news" class="img-fluid">
                                </a>
                                <div class="media-body">
                                    <div class="post-date-dark">
                                        <ul>
                            ...
                            <div class="media mb-30">
                                <a class="img-opacity-hover" href="single-news-3.html">
                                    <img src="{{asset('FrontSite/img/news/news26.jpg')}}" alt="news" class="img-fluid">
                                </a>
                                <div class="media-body">
                                    <div class="post-date-dark">
                                        <ul>
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            <div class="img-overlay-70 img-scale-animate mb-30">
                                ...
                                <img src="{{asset('FrontSite/img/news/news27.jpg')}}" alt="news" class="img-fluid width-100">
                            </div>
                            <div class="media mb-30">
                                <a class="img-opacity-hover" href="single-news-1.html">
                                    <img src="{{asset('FrontSite/img/news/news28.jpg')}}" alt="news" class="img-fluid">
                                </a>
                                <div class="media-body">
                                    <div class="post-date-dark">
                                        <ul>
                            ...
                            <div class="media mb-30">
                                <a class="img-opacity-hover" href="single-news-2.html">
                                    <img src="{{asset('FrontSite/img/news/news29.jpg')}}" alt="news" class="img-fluid">
                                </a>
                                <div class="media-body">
                                    <div class="post-date-dark">
                                        <ul>
                            ...
                            <div class="media mb-30">
                                <a class="img-opacity-hover" href="single-news-3.html">
                                    <img src="{{asset('FrontSite/img/news/news30.jpg')}}" alt="news" class="img-fluid">
                                </a>
                                <div class="media-body">
                                    <div class="post-date-dark">
                                        <ul>
                        ...
                        <div class="featuredContainer">
                            <div class="row tenies">
                                <div class="col-xl-4 col-lg-7 col-md-6 col-sm-12">
                                    <div class="img-overlay-70 img-scale-animate mb-30">
                                        <img src="{{asset('FrontSite/img/news/news31.jpg')}}" alt="news" class="img-fluid width-100">
                                    ...
                                    <div class="row keep-items-4-md">
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6">
                                            <div class="mb-25 position-relative">
                                                <a class="img-opacity-hover" href="single-news-1.html">
                                                    <img src="{{asset('FrontSite/img/news/news32.jpg')}}" alt="news" class="img-fluid width-100 mb-15">
                                                </a>
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6">
                                            <div class="mb-25 position-relative">
                                                <a class="img-opacity-hover" href="single-news-1.html">
                                                    <img src="{{asset('FrontSite/img/news/news33.jpg')}}" alt="news" class="img-fluid width-100 mb-15">
                                                </a>
                                                <div class="topic-box-top-xs">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6">
                                            <div class="mb-25 position-relative">
                                                <a class="img-opacity-hover" href="single-news-3.html">
                                                    <img src="{{asset('FrontSite/img/news/news34.jpg')}}" alt="news" class="img-fluid width-100 mb-15">
                                                </a>
                                                <div class="topic-box-top-xs">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6">
                                            <div class="mb-25 position-relative">
                                                <a class="img-opacity-hover" href="single-news-1.html">
                                                    <img src="{{asset('FrontSite/img/news/news35.jpg')}}" alt="news" class="img-fluid width-100 mb-15">
                                                </a>
                                                <div class="topic-box-top-xs">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6">
                                            <div class="mb-25 position-relative">
                                                <a class="img-opacity-hover" href="single-news-2.html">
                                                    <img src="{{asset('FrontSite/img/news/news36.jpg')}}" alt="news" class="img-fluid width-100 mb-15">
                                                </a>
                                                <div class="topic-box-top-xs">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-4 col-6">
                                            <div class="mb-25 position-relative">
                                                <a class="img-opacity-hover" href="single-news-3.html">
                                                    <img src="{{asset('FrontSite/img/news/news37.jpg')}}" alt="news" class="img-fluid width-100 mb-15">
                                                </a>
                                                <div class="topic-box-top-xs">
                                                    <div class="topic-box-sm color-cod-gray mb-20">Cycling</div>
                                                </div>
                            ...
                            <div class="row cricket">
                                <div class="col-xl-4 col-lg-7 col-md-6 col-sm-12">
                                    <div class="img-overlay-70 img-scale-animate mb-30">
                                        <img src="{{asset('FrontSite/img/news/news51.jpg')}}" alt="news" class="img-fluid width-100">
                                        <div class="topic-box-top-lg">
                            ...
                            <div class="row football">
                                <div class="col-xl-4 col-lg-7 col-md-6 col-sm-12">
                                    <div class="img-overlay-70 img-scale-animate mb-30">
                                        <img src="{{asset('FrontSite/img/news/news50.jpg')}}" alt="news" class="img-fluid width-100">
                                        <div class="topic-box-top-lg">
                            ...
                            <div class="row cycling">
                                <div class="col-xl-4 col-lg-7 col-md-6 col-sm-12">
                                    <div class="img-overlay-70 img-scale-animate mb-30">
                                        <img src="{{asset('FrontSite/img/news/news52.jpg')}}" alt="news" class="img-fluid width-100">
                                        <div class="topic-box-top-lg">
                                            <div class="topic-box-sm color-cod-gray mb-20">Cycling</div>
                                        </div>
                                        <div class="mask-content-lg">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row politics">
                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12">
                                            <div class="media media-none--lg mb-30">
                                                <div class="position-relative width-40">
                                                    <a href="single-news-1.html" class="img-opacity-hover">
                                                        <img src="{{asset('FrontSite/img/news/news38.jpg')}}" alt="news" class="img-fluid">
                                                    </a>
                                                    <div class="topic-box-top-xs">
                                                        <div class="topic-box-sm color-cinnabar mb-20">Politics</div>
                                                    </div>
                                        ...
                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12">
                                            <div class="media media-none--lg mb-30">
                                                <div class="position-relative width-40">
                                                    <a href="single-news-2.html" class="img-opacity-hover">
                                                        <img src="{{asset('FrontSite/img/news/news39.jpg')}}" alt="news" class="img-fluid">
                                                    </a>
                                                    <div class="topic-box-top-xs">
                                                        <div class="topic-box-sm color-web-orange mb-20">Food</div>
                                                    </div>
                                        ...
                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12">
                                            <div class="media media-none--lg mb-30">
                                                <div class="position-relative width-40">
                                                    <a href="single-news-3.html" class="img-opacity-hover">
                                                        <img src="{{asset('FrontSite/img/news/news40.jpg')}}" alt="news" class="img-fluid">
                                                    </a>
                                                    <div class="topic-box-top-xs">
                                        ...
                                        <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12">
                                            <div class="media media-none--lg mb-30">
                                                <div class="position-relative width-40">
                                                    <a href="single-news-1.html" class="img-opacity-hover">
                                                        <img src="{{asset('FrontSite/img/news/news41.jpg')}}" alt="news" class="img-fluid">
                                                    </a>
                                                    <div class="topic-box-top-xs">
                        ...
                        <div class="ne-sidebar sidebar-break-md col-lg-4 col-md-12">
                            <div class="sidebar-box">
                                <div class="ne-banner-layout1 text-center">
                                    <a href="#">
                                        <img src="{{asset('FrontSite/img/banner/banner6.jpg')}}" alt="ad" class="img-fluid">
                                    </a>
                                </div>
                            </div>
                            <div class="sidebar-box">
                                ...
                                <div class="newsletter-area bg-primary">
                                    ...
                                    <img src="{{asset('FrontSite/img/banner/newsletter.png')}}" alt="newsletter" class="img-fluid mb-40">
                    ...
                    <div class="row tab-space1">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="category-box-layout1 overlay-dark-level-2 img-scale-animate text-center mb-2">
                                <img src="{{asset('FrontSite/img/category/ctg1.jpg')}}" alt="news" class="img-fluid width-100">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="category-box-layout1 overlay-dark-level-2 img-scale-animate text-center mb-2">
                                <img src="{{asset('FrontSite/img/category/ctg2.jpg')}}" alt="news" class="img-fluid width-100">
                                <div class="content p-30-r">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="category-box-layout1 overlay-dark-level-2 img-scale-animate text-center mb-2">
                                <img src="{{asset('FrontSite/img/category/ctg3.jpg')}}" alt="news" class="img-fluid width-100">
                                <div class="content p-30-r">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="category-box-layout1 overlay-dark-level-2 img-scale-animate text-center mb-2">
                                <img src="{{asset('FrontSite/img/category/ctg4.jpg')}}" alt="news" class="img-fluid width-100">
                                <div class="content p-30-r">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="category-box-layout1 overlay-dark-level-2 img-scale-animate text-center mb-2">
                                <img src="{{asset('FrontSite/img/category/ctg5.jpg')}}" alt="news" class="img-fluid width-100">
                                <div class="content p-30-r">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="category-box-layout1 overlay-dark-level-2 img-scale-animate text-center mb-2">
                                <img src="{{asset('FrontSite/img/category/ctg6.jpg')}}" alt="news" class="img-fluid width-100">
                                <div class="content p-30-r">
                                    <div class="ctg-title-xs">Education</div>
                                    <h3 class="title-regular-light size-lg">
                                        ...
                                        <li>
                                            <div class="media">
                                                <a href="post-style-1.html">
                                                    <img src="{{asset('FrontSite/img/footer/post1.jpg')}}" alt="post" class="img-fluid">
                                                </a>
                                                <div class="media-body">
                                        ...
                                        <li>
                                            <div class="media">
                                                <a href="post-style-2.html">
                                                    <img src="{{asset('FrontSite/img/footer/post2.jpg')}}" alt="post" class="img-fluid">
                                                </a>
                                                <div class="media-body">
                                                    <h3 class="title-medium-light size-md mb-10">
                                        ...
                                        <li>
                                            <div class="media">
                                                <a href="post-style-3.html">
                                                    <img src="{{asset('FrontSite/img/footer/post3.jpg')}}" alt="post" class="img-fluid">
                                                </a>
                                                <div class="media-body">
                                                    <h3 class="title-medium-light size-md mb-10">
                                    ...
                                    <ul class="post-gallery shine-hover ">
                                        <li>
                                            <a href="gallery-style1.html">
                                                <figure>
                                                    <img src="{{asset('FrontSite/img/footer/post4.jpg')}}" alt="post" class="img-fluid">
                                                </figure>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="gallery-style2.html">
                                                <figure>
                                                    <img src="{{asset('FrontSite/img/footer/post5.jpg')}}" alt="post" class="img-fluid">
                                                </figure>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="gallery-style1.html">
                                                <figure>
                                                    <img src="{{asset('FrontSite/img/footer/post6.jpg')}}" alt="post" class="img-fluid">
                                                </figure>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="gallery-style2.html">
                                                <figure>
                                                    <img src="{{asset('FrontSite/img/footer/post7.jpg')}}" alt="post" class="img-fluid">
                                                </figure>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="gallery-style1.html">
                                                <figure>
                                                    <img src="{{asset('FrontSite/img/footer/post8.jpg')}}" alt="post" class="img-fluid">
                                                </figure>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="gallery-style2.html">
                                                <figure>
                                                    <img src="{{asset('FrontSite/img/footer/post9.jpg')}}" alt="post" class="img-fluid">
                                                </figure>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="gallery-style1.html">
                                                <figure>
                                                    <img src="{{asset('FrontSite/img/footer/post10.jpg')}}" alt="post" class="img-fluid">
                                                </figure>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="gallery-style2.html">
                                                <figure>
                                                    <img src="{{asset('FrontSite/img/footer/post11.jpg')}}" alt="post" class="img-fluid">
                                                </figure>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="gallery-style1.html">
                                                <figure>
                                                    <img src="{{asset('FrontSite/img/footer/post12.jpg')}}" alt="post" class="img-fluid">
                                                </figure>
                                            </a>
                                        </li>
                                    </ul>
